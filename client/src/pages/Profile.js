...
function Profile() {
    ...
    useEffect(() => {
        axios.get(`http://localhost:5060/users/basicinfo/${id}`).then((response) => {
        ...
        axios.get(`http://localhost:5060/posts/byUserId/${id}`).then((response) => {
            setListOfUserPosts(response.data)
        })
        axios.get(`http://localhost:5060/posts/byFavoriteId/${id}`).then((response) => {
